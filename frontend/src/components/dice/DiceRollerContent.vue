<template>
  <v-card class="dice-chat-card elevation-0 h-100 d-flex flex-column" :class="{ 'glass-card': !inline }">
    <v-card-title v-if="!hideHeader" class="d-flex align-center py-2 px-3">
    ...
    <!-- Chat Messages -->
    <v-card-text class="chat-messages pa-0 flex-grow-1 overflow-y-auto">
      <v-list
